...
<option value="CNG">CNG</option>
              ...
              <a href="car-listing.php"><button type="button" class="btn btn-block"><i class="fa fa-car" aria-hidden="true"></i>View all cars</button></a>
            </form>
          </div>
        </div>
