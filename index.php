      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <a href="car-listing.php" class="btn">Check it out! <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>We at JaCar help you find the best car suited to your need. Need a car for Friends Night out? Or one for a family outing? Or meeting your Boss Don't worry our wide variety of cars will help you choose the right car for your needs.</p>
    </div>
    <div class="row"> 
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-coffee" aria-hidden="true"></i>1000+</h2>
            <p>Coffee Cups</p>
          </div>
        </div>
      </div>
      ...
      <div id="testimonial-slider">
        ...
        <div class="testimonial-m">
          <div class="testimonial-content">
            <div class="testimonial-heading">
              <h5>Mohit Kumar</h5>
            <p>Great Website. Easy to navigate, lots of useful featurs. Hassle free Bookings</p>
          </div>
        </div>
        </div> 
        ...
        <div class="testimonial-m">
          <div class="testimonial-content">
            <div class="testimonial-heading">
              <h5>Harsh Jain</h5>
            <p>Easiest platform to book cars for rent. Quick and easy service. Wide variety</p>
          </div>
        </div>
        </div> 
        ...
        <div class="testimonial-m">
          <div class="testimonial-content">
            <div class="testimonial-heading">
              <h5>Vaibhav</h5>
            <p>Quick, Reliable and efficient</p>
          </div>
        </div>
        </div> 
